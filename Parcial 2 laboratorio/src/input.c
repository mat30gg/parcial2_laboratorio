...
int SolicitarArchivo(char* msg, char* destino, char* extension)
{
	int exito = 0;
	getString(msg, destino);
	AgregarExtension(destino, extension);
	if(destino != NULL)
	{
		exito = 1;
	}
...
int AgregarExtension(char* cadena, char* extension)
{
	int exito = 0;
	if(cadena != NULL)
	{
